      ...
      <div className="w-full max-w-md bg-white border border-gray-200 rounded-xl shadow-sm p-8">
        ...
        <div className="space-y-4">
          ...
          <div className="flex justify-center">
            <Button label={loading ? "Logging in..." : "Login"} onClick={handleSubmit} variant="primary" disabled={loading} />
          </div>
        </div>
        ...
        <div className="fixed top-4 right-4 z-50 animate-slideIn">
          <div className="bg-green-50 border border-green-200 rounded-lg shadow-lg p-4 max-w-sm w-80">
            <div className="flex items-start gap-3">
              ...
              <button onClick={() => setShowPopup(false)} className="flex-shrink-0 text-green-400 hover:text-green-600 transition-colors">
                <X className="w-4 h-4" />
              </button>
            </div>
          </div>
