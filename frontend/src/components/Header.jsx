        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl max-w-sm w-full shadow-xl overflow-hidden animate-fadeIn">
            ...
            <div className="px-6 py-4 bg-gray-50 border-t border-gray-100 flex gap-3 justify-end">
              <Button label="Cancel" onClick={cancelLogout} variant="ghost" />
              <Button label="Logout" onClick={confirmLogout} variant="danger" />
            </div>
          </div>
        </div>
      )}
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl max-w-md w-full shadow-xl overflow-hidden animate-fadeIn">
            ...
            <div className="px-6 py-4 bg-gray-50 border-t border-gray-100 flex justify-end">
              <Button label="Close" onClick={handleCloseModal} variant="ghost" />
            </div>
          </div>
        </div>
      )}
